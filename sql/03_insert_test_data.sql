...
('C001', '数据库系统', 3.0, 48, '考试', '必修', '关系数据库与 openGauss 实践'),
('C002', 'Java Web 开发', 3.0, 48, '考试', '必修', 'Spring Boot 与 MVC 开发'),
('C003', '数据结构', 4.0, 64, '考试', '必修', '线性表、树和图'),
('C004', '操作系统', 3.5, 56, '考试', '必修', '进程、内存与文件系统'),
('C005', '计算机网络', 3.0, 48, '考试', '必修', '网络协议基础'),
('C006', '软件工程', 2.5, 40, '考查', '必修', '需求、设计与测试'),
('C007', '大数据分析', 3.0, 48, '考试', '选修', '数据处理与分析'),
('C008', '人工智能导论', 2.0, 32, '考查', '通识', 'AI 基础概念');
...
('TASK001', 'C001', 'T001', 'CL-CS2301', 'TERM-2025-3', '博易楼A101', 8, 5, '开课中', 'Y'),
('TASK002', 'C001', 'T002', 'CL-CS2302', 'TERM-2025-3', '博易楼A102', 8, 5, '开课中', 'Y'),
('TASK003', 'C002', 'T003', 'CL-SE2301', 'TERM-2025-3', '博易楼B201', 8, 5, '开课中', 'N'),
('TASK004', 'C007', 'T004', 'CL-DS2301', 'TERM-2025-3', '博易楼B202', 8, 5, '开课中', 'Y'),
('TASK005', 'C003', 'T005', 'CL-CS2301', 'TERM-2024-2', '广知楼C301', 8, 5, '已结束', 'Y'),
('TASK006', 'C004', 'T006', 'CL-CS2302', 'TERM-2024-2', '广知楼C302', 8, 5, '已结束', 'Y'),
('TASK007', 'C005', 'T001', 'CL-SE2301', 'TERM-2024-2', '广知楼D401', 8, 5, '已结束', 'Y'),
('TASK008', 'C006', 'T002', 'CL-DS2301', 'TERM-2024-2', '广知楼D402', 8, 5, '已结束', 'Y'),
('TASK009', 'C008', 'T003', 'CL-CS2301', 'TERM-2024-1', '仁和楼E101', 8, 5, '已结束', 'Y'),
('TASK010', 'C008', 'T004', 'CL-SE2301', 'TERM-2024-1', '仁和楼E102', 8, 5, '已结束', 'Y');
